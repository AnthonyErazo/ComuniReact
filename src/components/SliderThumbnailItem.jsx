...
const SliderThumbnailItem = ({ itemActive, id, image, name, onClick }) => {
    ...
    return (
        <li
            ...
            className={cn(
                ...
                itemActive==id ? 'brightness-150 w-[200px]' : 'brightness-50 w-[50px]'
            )}
        >
            <div className='relative w-full h-full rounded-lg'>
                <img src={image} alt='Image' className='object-cover rounded-lg w-full h-full' />
            </div>
            <div
                className={cn(
