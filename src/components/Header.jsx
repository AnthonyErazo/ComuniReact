...
const Header = ({
    ...
    return (
        <header className="lg:hidden sticky top-0 z-999 flex w-full  bg-boxdark drop-shadow-none">
            <div className="flex flex-grow justify-end px-4 py-4 shadow-2 md:px-6 2xl:px-11">
