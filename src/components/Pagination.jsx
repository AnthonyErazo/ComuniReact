        ...
        <div className="flex bg-primary px-4 py-3 justify-center">
            <div className="flex items-center justify-center text-white">
                <div className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                    ...
                    <a href="#" aria-current="page" className="relative z-10 inline-flex items-center px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-black-gradient-2">1</a>
