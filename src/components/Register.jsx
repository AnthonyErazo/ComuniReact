                    ...
                    <div className="mx-auto max-w-screen-xl p-4 md:p-6 2xl:p-10">
                        <div className="rounded-sm border shadow-default border-strokedark bg-boxdark">
                            <div className="flex flex-wrap items-center">
                                ...
                                <div className="w-full border-strokedark lg:w-1/2 lg:border-l-2">
                                    <div className="w-full p-17.5">
                                        ...
                                        <form onSubmit={handleSubmit}>
                                            <div className="mb-4">
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <span className="absolute right-4 top-4">
                                                        <TfiEmail className='fill-white w-5 h-5' />
                                                    </span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="mt-6 text-center text-white">
                                                <Link to="/" className="text-white flex gap-5">
                                                    <BiArrowBack className='w-5 fill-white' />
                                                    <p>
                                                        Regresar
                                                    </p>
                                                </Link>
