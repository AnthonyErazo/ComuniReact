...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'arrow-right':'linear-gradient(to left, rgb(0 4 15 / var(--tw-bg-opacity)) 10%, rgba(0, 4, 15, 0) 100%)',
        'arrow-left':'linear-gradient(to right, rgb(0 4 15 / var(--tw-bg-opacity)) 10%, rgba(0, 4, 15, 0) 100%)',
